...
import {RailroadNetwork} from './RailroadNetwork.js';
...
var BLUE_INIT_BOARD_STATE = {
  a12: new Piece('r', '-1'), b12: new Piece('r', '-1'), c12: new Piece('r', '-1'), d12: new Piece('r', '-1'), e12: new Piece('r', '-1'),
  a11: new Piece('r', '-1'),  b11: new Piece('r', '-1'), c11: new Piece('r', '-1'), d11: new Piece('r', '-1'), e11: new Piece('r', '-1'),
  a10: new Piece('r', '-1'),  b10: null,                 c10: new Piece('r', '-1'), d10: null,                e10: new Piece('r', '-1'),
  a9:  new Piece('r', '-1'),  b9: new Piece('r', '-1'),   c9: null,                 d9: new Piece('r', '-1'),  e9: new Piece('r', '-1'),
  a8:  new Piece('r', '-1'),  b8: null,                  c8: new Piece('r', '-1'),  d8: null,                 e8: new Piece('r', '-1'),
  a7:  new Piece('r', '-1'),  b7: new Piece('r', '-1'),   c7: new Piece('r', '-1'),  d7: new Piece('r', '-1'), e7: new Piece('r', '-1'),
...
var RED_INIT_BOARD_STATE = {
  ...
  a6:  new Piece('b', '-1'),  b6: new Piece('b', '-1'),   c6: new Piece('b', '-1'),  d6: new Piece('b', '-1'),  e6: new Piece('b', '-1'),
  a5:  new Piece('b', '-1'),  b5: null,                  c5: new Piece('b', '-1'),  d5: null,                 e5: new Piece('b', '-1'),
  a4:  new Piece('b', '-1'),  b4: new Piece('b', '-1'),   c4: null,                 d4: new Piece('b', '-1'),  e4: new Piece('b', '-1'),
  a3:  new Piece('b', '-1'),  b3: null,                  c3: new Piece('b', '-1'),  d3: null,                 e3: new Piece('b', '-1'),
  a2:  new Piece('b', '-1'),  b2: new Piece('b', '-1'),  c2: new Piece('b', '-1'), d2: new Piece('b', '-1'), e2: new Piece('b', '-1'),
  a1:  new Piece('b', '-1'),  b1: new Piece('b', '-1'),  c1: new Piece('b', '-1'), d1: new Piece('b', '-1'), e1: new Piece('b', '-1')
};
...
*/
export function Board(playerColor)
{ 
  if (playerColor == 'blue'){
    console.log('blue setup');
    this.boardState = BLUE_INIT_BOARD_STATE;
  }else{
    console.log('red setup');
    this.boardState = RED_INIT_BOARD_STATE;
  }
